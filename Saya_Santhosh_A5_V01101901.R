...
hist(wbnew$total_consumption, breaks = 15, col = 'blue', border = 'black', 
     xlab = "Consumption", ylab = "Frequency", main = "Consumption Distribution in West Bengal State")
...
data_map <- st_read("C:\\Users\\sayas\\Downloads\\KARNATAKA_DISTRICTS.geojson") 
View(data_map)
